...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RequestState&&(identical(other.url, url) || other.url == url));
}
...
class _Request implements RequestState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Request&&(identical(other.url, url) || other.url == url));
}
...
/// @nodoc
abstract mixin class _$RequestCopyWith<$Res> implements $RequestStateCopyWith<$Res> {
