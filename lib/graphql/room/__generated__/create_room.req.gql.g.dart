...
part of 'create_room.req.gql.dart';
...
class _$GCreateRoomReqSerializer
  ...
  GCreateRoomReq deserialize(
    ...
    final result = GCreateRoomReqBuilder();
...
class _$GCreateRoomReq extends GCreateRoomReq {
  ...
  factory _$GCreateRoomReq([void Function(GCreateRoomReqBuilder)? updates]) =>
      (GCreateRoomReqBuilder()..update(updates))._build();
  ...
  @override
  GCreateRoomReqBuilder toBuilder() => GCreateRoomReqBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GCreateRoomReq')
          ..add('vars', vars)
...
class GCreateRoomReqBuilder
  ...
  _i3.GCreateRoomVarsBuilder get vars =>
      _$this._vars ??= _i3.GCreateRoomVarsBuilder();
  ...
  _i2.GCreateRoomDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= _i2.GCreateRoomDataBuilder();
  ...
  @override
  GCreateRoomReq build() => _build();

  _$GCreateRoomReq _build() {
