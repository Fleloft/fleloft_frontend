...
mixin _$RoleModel {
 ...
 int? get dbId; String? get id; String? get name;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoleModel&&(identical(other.dbId, dbId) || other.dbId == dbId)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}


@override
int get hashCode => Object.hash(runtimeType,dbId,id,name);

@override
String toString() {
  return 'RoleModel(dbId: $dbId, id: $id, name: $name)';
}
...
@useResult
$Res call({
 int? dbId, String? id, String? name
});
...
/// Create a copy of RoleModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dbId = freezed,Object? id = freezed,Object? name = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? dbId,  String? id,  String? name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoleModel() when $default != null:
return $default(_that.dbId,_that.id,_that.name);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? dbId,  String? id,  String? name)  $default,) {final _that = this;
switch (_that) {
case _RoleModel():
return $default(_that.dbId,_that.id,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? dbId,  String? id,  String? name)?  $default,) {final _that = this;
switch (_that) {
case _RoleModel() when $default != null:
return $default(_that.dbId,_that.id,_that.name);case _:
  return null;
...
class _RoleModel implements RoleModel {
  const _RoleModel({this.dbId, this.id, this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RoleModel&&(identical(other.dbId, dbId) || other.dbId == dbId)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
/// Create a copy of RoleModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dbId = freezed,Object? id = freezed,Object? name = freezed,}) {
