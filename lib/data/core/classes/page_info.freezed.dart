...
mixin _$PageInfo {
 ...
 bool get hasNextPage; bool get hasPreviousPage; String? get startCursor; String? get endCursor;
...
/// Create a copy of PageInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hasNextPage = null,Object? hasPreviousPage = null,Object? startCursor = freezed,Object? endCursor = freezed,}) {
...
as bool,startCursor: freezed == startCursor ? _self.startCursor : startCursor // ignore: cast_nullable_to_non_nullable
as String?,endCursor: freezed == endCursor ? _self.endCursor : endCursor // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hasNextPage,  bool hasPreviousPage,  String? startCursor,  String? endCursor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PageInfo() when $default != null:
return $default(_that.hasNextPage,_that.hasPreviousPage,_that.startCursor,_that.endCursor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool hasNextPage,  bool hasPreviousPage,  String? startCursor,  String? endCursor)  $default,) {final _that = this;
switch (_that) {
case _PageInfo():
return $default(_that.hasNextPage,_that.hasPreviousPage,_that.startCursor,_that.endCursor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool hasNextPage,  bool hasPreviousPage,  String? startCursor,  String? endCursor)?  $default,) {final _that = this;
switch (_that) {
case _PageInfo() when $default != null:
return $default(_that.hasNextPage,_that.hasPreviousPage,_that.startCursor,_that.endCursor);case _:
  return null;
...
class _PageInfo implements PageInfo {
  const _PageInfo({this.hasNextPage = true, this.hasPreviousPage = false, this.startCursor, this.endCursor});
...
/// Create a copy of PageInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hasNextPage = null,Object? hasPreviousPage = null,Object? startCursor = freezed,Object? endCursor = freezed,}) {
